...
<head>
    ...
    <link rel="stylesheet" href="../dir_css/product_editAdmin.css">
    ...
    <link rel="stylesheet" href="css/product_edit_Admin.css">
</head>
<body>
<header>
            ...
            <div class="row">
                ...
                <div class="col-lg-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <img src="..//image/Thiết bị y tế/Máy đo huyết áp/7143T1 full pk.webp" alt=""
                                 class="img-fluid rounded bg-light">
                            <div class="mt-3">
                                <h4>Máy đo huyết áp<span class="fs-14 text-muted ms-1">(Thiết bị y tế)</span>
                                </h4>
                                <h5 class="text-dark fw-medium mt-3">Giá: 1.240.000</h5>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <%--@declare id="product-categories"--%><label for="product-categories" class="form-label">Danh mục sản
                                        phẩm</label>
                                    <div class="dropdown">
                    ...
                    <div class="p-3 bg-light mb-3 rounded">
                        <div class="row justify-content-end g-2">
                            <div class="col-lg-2">
                                <a href="#!" class="btn btn-outline-secondary w-100">Thiết lập lại</a>
                            </div>
                            <div class="col-lg-2">
                                <a href="#!" class="btn btn-primary w-100">Lưu thay đổi</a>
                            </div>
                        </div>
                    </div>
                </div>
...
<script src="js/product_edit_Admin.js"></script>
</body>
